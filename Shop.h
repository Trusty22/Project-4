...
public:
  // Constructor
  Shop_org(int num_barbers, int num_chairs, int max_customer) : max_barbers_((num_barbers > 0) ? num_barbers : kDefaultBarbers),
...
public:
  // Constructor
  Barber(int barber_id, int customer_in_chair, bool in_service, bool money_paid) : barber_id_(barber_id),
